...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(isset($_POST['add_team_member']) && $role === 'admin') {
        ...
        $query = "INSERT INTO team_members (name, position, bio, role, department, skills, linkedin, github, twitter, email, phone, image) 
                  VALUES ('$name', '$position', '$bio', '$team_role', '$department', '$skills', '$linkedin', '$github', '$twitter', '$email', '$phone', '$profile_image')";
    ...
    if(isset($_POST['edit_team_member']) && $role === 'admin') {
        ...
        // Get current image
        $current_query = "SELECT image FROM team_members WHERE id = $id";
        $current_result = mysqli_query($conn, $current_query);
        $current_member = mysqli_fetch_assoc($current_result);
        $profile_image = $current_member['image'];
        ...
        $query = "UPDATE team_members SET name = '$name', position = '$position', bio = '$bio', 
                  ...
                  twitter = '$twitter', email = '$email', phone = '$phone', image = '$profile_image' WHERE id = $id";
                    ...
                    <form method="POST" action="#team" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload">
                                <input type="file" id="member-image" name="profile_image" accept=".jpg, .jpeg, .png">
                            ...
                            <div class="file-preview" style="display: none;">
                                <img id="member-preview-image" src="#" alt="Preview" style="max-width: 150px; max-height: 150px; border-radius: 8px; margin-top: 10px;">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="member-role" name="team_role" required>
                                    ...
                                    <option value="staff_incharge">Staff Incharge</option>
                    ...
                    <div class="team-hierarchy">
                        ...
                        <div class="team-category">
                            ...
                            <div class="team-members-grid">
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '<p class="no-data">No dean or HOD members found.</p>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="team-category">
                            ...
                            <div class="team-members-grid">
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        echo '<div class="team-member-card staff">';
                                        echo '<div class="member-image">';
                                        echo '<img src="'.(!empty($row['image']) ? 'uploads/team/'.$row['image'] : 'images/default-avatar.png').'" alt="'.$row['name'].'">';
                                        echo '</div>';
                                        echo '<div class="member-info">';
                                    ...
                                    echo '<p class="no-data">No staff incharge found.</p>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="team-category">
                            <h4>President & Vice President</h4>
                            <div class="team-members-grid">
                                <?php
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '<p class="no-data">No president or vice president found.</p>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="team-category">
                            <h4>Technical Head & Non-Technical Head</h4>
                            <div class="team-members-grid">
                                <?php
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '<p class="no-data">No technical or non-technical heads found.</p>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="team-category">
                            ...
                            <div class="team-members-grid">
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '<p class="no-data">No domain leads found.</p>';
                                }
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="team-category">
                            <h4>Management Head & Photography Head & Social Media Manager & Accountant</h4>
                            <div class="team-members-grid">
                                <?php
                                ...
                                if(mysqli_num_rows($result) > 0) {
                                    while($row = mysqli_fetch_assoc($result)) {
                                        echo '<div class="team-member-card support">';
                                        echo '<div class="member-image">';
                                        echo '<img src="'.(!empty($row['image']) ? 'uploads/team/'.$row['image'] : 'images/default-avatar.png').'" alt="'.$row['name'].'">';
                                        echo '</div>';
                                        echo '<div class="member-info">';
                                    ...
                                    echo '<p class="no-data">No support staff found.</p>';
                                }
                                ?>
                            </div>
                        </div>
...
<table border="1" cellpadding="10" cellspacing="0" width="100%">
    ...
    <script>
                        ...
                        modalBody.innerHTML = `
                            ...
                            <form method="POST" action="#team" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="file-upload">
                                        <input type="file" name="profile_image" accept=".jpg, .jpeg, .png" onchange="previewEditImage(this)">
                                        <div class="file-upload-btn">
                                            <i class="fas fa-upload"></i>
                                            <span>Choose File</span>
                                        </div>
                                    ...
                                    <div class="file-preview">
                                        <img id="edit-preview-image" src="${member.image ? 'uploads/team/' + member.image : 'images/default-avatar.png'}" alt="Preview" style="max-width: 150px; max-height: 150px; border-radius: 8px; margin-top: 10px;">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <select name="team_role" required>
                                            ...
                                            <option value="staff_incharge" ${member.role === 'staff_incharge' ? 'selected' : ''}>Staff Incharge</option>
        ...
        // File upload preview for adding new member
        document.getElementById('member-image').addEventListener('change', function() {
            const file = this.files[0];
            const fileName = document.querySelector('#team .file-name');
            const previewContainer = document.querySelector('#team .file-preview');
        ...
        // Custom file input button for adding new member
        document.querySelector('#team .file-upload-btn').addEventListener('click', function() {
            document.getElementById('member-image').click();
        });

        // File upload preview for editing member
